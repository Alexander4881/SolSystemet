...
function drawRectangle(x, y, style) {
    ...
    playerImg.onload = function(){
        ...
        mazeImg.src = "../Picture/maz2.png";
        context.drawImage(mazeImg, 0, 0);
        context.drawImage(playerImg, currRectX, currRectY);
...
function moveRect(e) {
    ...
    if (movingAllowed === 1) {      // 1 means 'the rectangle can move'
        drawRectangle(newX, newY, "#d4f542");
        currRectX = newX;
        currRectY = newY;
    }
